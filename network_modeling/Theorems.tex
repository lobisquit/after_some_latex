...
\usepackage{amsthm}
\usepackage{amsmath,amssymb,mathtools,bm,etoolbox,dsfont}
...
%\title{Zorzilla's Theorems\thanks{Newtork Modeling}}
%\author{Ettore Mariotti}
%%%%%%%%%%%%


\begin{document}
%\includegraphics[width=\textwidth]{Zorzilla}
%\maketitle
