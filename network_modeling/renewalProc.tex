...
\subsection{Time intervals}
	...
	This paradox is easily explained with the concept of \emph{picking bias}: the choice of a random observation time $t$ changes the statistical behaviour of the time interval, since bigger ones are privileged.
