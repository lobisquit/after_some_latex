...
The main idea of a renewal process is a cyclic recurrence of a random phenomenon presenting always the same statistics.
...
\begin{definition}[Renewal Process]
	...
	\begin{itemize}
		...
		\item $ F(+\infty) = 0 \rightarrow $ renewals repeat themselves forever
	\end{itemize}
\end{definition}
