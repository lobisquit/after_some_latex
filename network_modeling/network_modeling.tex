...
\usetikzlibrary{automata, arrows, positioning, calc, shapes}

% image path
\graphicspath{ {./img/} }

% add support for url and cross-references in PDF ou8tput
\usepackage{url}
...
{\Large Ettore Mariotti, Andrea Pittaro, Enrico Lovisotto, Davide Peron, Federico Mason, Lorenza Prospero, Cristina Gava, Ciprian Matteo\par}
