...
\begin{tikzpicture}
  ...
  \path[-stealth,blue,dotted] (taKa2) edge[bend left] node[below left, rotate=0] {$P_C$} (tl);
  \path[->] (taKa2) edge[bend right] node[above, rotate=0] {$1-P_C$} (taKa1);
  \path[-stealth,blue,dotted] (taKa1) edge[bend right, in=180,out=-40] node[above, rotate=0] {$P_C$} (tl);
