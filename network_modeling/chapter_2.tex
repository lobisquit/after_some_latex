...
\begin{esp}\label{eq:s-to1}
	...
	&=\pi_0 \cdot \lim_{s\to 1} \left(1-\underbrace{\frac{A(s)-1}{s-1}}_{(1)}\right)^{-1} = \pi_0\cdot\left[1-A^{\prime}(1)\right]^{-1} = \frac{\pi_0}{1-A^\prime(1)}
\end{esp}
...
The table \Tab{tab:rw} summarize the result we just found
\begin{table}[h]
\centering
\label{tab:rw}
\begin{tabular}{c|c|c}
