...
For example
\begin{equation}
\prob[X_3 = i_3 , X_2 = i_2, X_1 = i_1, X_ = i_0]=P_{i_0}\cdot P_{i_0,i_1}\cdot P_{i_1,i_2}\cdot P_{i_2,i_3}
\end{equation}
...
\subsection{Classes of states}
	...
	$$ f_{ii} = \sum\limits_{n=1}^\infty f_{ii}(n)  = \sum\limits_{n=1}^\infty P[R_i=n | X_0=i] $$
	...
	\begin{definition}
		...
		$$\mathbb{E}[M | X_0 = i] = \sum\limits_{k=1}^\infty \mathbb{P}[M\geq k | X_0 = i] = \sum\limits_{k=1}^\infty f_{ii}^k = \begin{cases}
		\frac{f_{ii}}{1-f_ii}, & \text{if transient} \\
    ...
    $$ \mathbb{E}[M | X_0 = i] = \mathbb{E}\left[\sum\limits_{n=1}^\infty \mathds{1}\{X_n = i\} | X_0 = i\right]
    = \sum\limits_{n=1}^\infty \mathbb{E}\left[\mathds{1}\{ X_n = i\} | X_0 = i\right] = \sum\limits_{n=1}^\infty P_{ii}^{(n)} $$
		So we have shown that $\mathbb{E}[M | X_0=i] = \sum\limits_{n=1}^\infty P_{ii}^{(n)}$.\\
	...
	\begin{center}
		\begin{tabular}{|l*{6}{|c}r}
			\hline
			State $i$ & $f_{ii} = \sum\limits_{n=1}^\infty f_{ii}^{(n)}$  & $\lim\limits_{k \to \infty } \mathbb{P}[M \geq k | X_0=i]$ & $\mathbb{E}[n|X_0=i]$ & $m_i = \sum\limits_n f_{ii}^{(n)}$ & $\pi_i = \frac{1}{m_i}$  \\ \hline
