...
\begin{titlepage}
	\begin{center}
		\hspace{0.5cm}
		\fontsize{30}{30}{\textsc{Antenne e propagazione}} \\
    \vspace{0.2cm}
    \fontsize{30}{30}{\textsc{wireless}} \\
		\vspace{1cm}
    \centering
		\includegraphics[width=\textwidth]{copertina.png}\\
		\vspace{0.5cm}
		\large{\emph{scritto da}} \\
		\vspace{0.5cm}
...
\input{polarizzazione.tex}
\input{onde_piane.tex}
\input{antenne_cap.tex}
\input{filiformi.tex}
\input{antenneSuPianoCond.tex}
\input{array.tex}
\input{patch.tex}
% \appendix
% \input{appendici.tex}
