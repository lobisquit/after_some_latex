\section{Propagazione guidata} \label{sec:propagazione_guidata}
...
\begin{esp} \label{eq:AE}
	\rot\E &= - \jmath \omega \mu \frac{1}{\mu} \rot \A \quad \Rightarrow \quad \rot\left(\E + \jmath \omega \A\right)=0
\end{esp}
...
\begin{esp}
	\rot \H &= \jmath \omega \epsilon_c \E + \J =  \rot\left(\frac{1}{\mu} \rot \A\right)\\
	\rot \H &= \jmath \omega \mu \epsilon_c \left(-\jmath \omega \A - \nabla \phi \right) + \mu \J \\
	-\nabla^2\A + \nabla \, (\diverg \A) &= \omega^2 \mu \epsilon_c \A - \jmath \omega \mu \epsilon_c \nabla \phi + \mu \J \\
	\nabla^2 \A + \omega^2 \mu \epsilon_c \A
		&= -\mu\J + \nabla \, (\diverg \A) + \jmath \omega \mu \epsilon_c \nabla \phi \\
...
\begin{esp*}
	...
	+ \omega^2 \mu \epsilon \int_V \left(\frac{c}{r}\, \ejbr \right) \de V \bigg] = \\
	& = -\mu \lim_{r^\prime \to 0} \int_V I \,  \delta(x) \, \delta(y) \,  F(z) \de V \\
\end{esp*}
% TODO mettere i passaggi nell'appendice
...
\begin{esp*}
	P_{IN}
	&= P + P_{_0}
	= P + R_{_0} \, \frac{|I_A|^2}{2}
	\stackrel{(*)}{=} R_r \frac{|I_A|^2}{2} + R_{_0} \\
	& = \left( R_r + R_{_0}  \right) \frac{|I_A|^2}{2}
	= R_A \, \frac{|I_A|^2}{2}
\end{esp*}
...
\begin{esp}\label{eq:pot-resRadDE}
	...
	\simeq 80\pi^2\left(\frac{\Delta z}{\lambda}\right)^2 \Omega
\end{esp}
...
\begin{esp} \label{eq:bilancio_EM_immaginario}
	...
	= \Im\left[- \int_V \frac{\E \cdot \J^*}{2} \de V\right] \\
	& \stackrel{(*)}{=}
	\omega \underbrace{\int_V \frac{1}{2} \left[\mu \frac{|\H|^2}{2} - \epsilon \frac{|\E|^2}{2} \right] \de V}_{1}
...
Nel caso del dipolo elementare si ha che $\h_T(\theta,\phi) = \Delta z \sin(\theta) \hth$.
...
\begin{esp*}
	...
	& \stackrel{(*)}{=} \frac{R_L \, |\E_i \cdot \h_R^*|^2}{2 \, |Z_L+Z_G|^2}
\end{esp*}
...
\begin{esp*}
	\E_i &= (E_x \, \hat{x}+E_y \, \hat{y}) \, e^{\textcolor[rgb]{0.8,0,0}{-}\jmath \beta z} \\
	\E_r &= (E_x \, \hat{x}+E_y \, \hat{y}) \, \rho \, e^{\textcolor[rgb]{0.8,0,0}{+}\jmath \beta z} \\
\end{esp*}
