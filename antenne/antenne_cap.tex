...
\begin{esp*}
	\hspace{-2cm}
	\nabla^2 A_z
	& = \frac{1}{r^2} \deriv{}{r}\left(r^2 \deriv{A_z(r)}{r}\right) =0\\
	\implies \nabla^2 A_z + \omega^2\, \mu\, \epsilon A_z & = \frac{1}{r^2} \deriv{}{r}\left(r^2 \deriv{\frac{f(r)}{r}}{r}\right) + \omega^2 \mu\epsilon\frac{f(r)}{r} \\
	& = \frac{1}{r} \deriv{}{r}\left(r^2 \frac{f'(r)\cdot r - f(r)}{r^2}\right) + \omega^2 \mu\epsilon\, f(r)\\
	& = \frac{1}{r} \left[
...
\begin{esp*}
	...
	& = -\mu \lim_{r^\prime \to 0} \int_V I \delta(x)\delta(y) g(z) \de V \\
\end{esp*}

% questo passaggio non mi torna: ho dubbi sui differenziali
\begin{esp*}
	& \lim_{r \to 0} \left[ \int_{0}^r c \left(
			-\jmath \beta \frac{\ejbr}{r}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=5cm]{solido-dirett.png}
