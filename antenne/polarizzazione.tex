...
\begin{esp}
<<<<<<< HEAD
  \ert &= \sum\limits_{n=1}^3 \hat{x}_n^{\prime\prime} \, E_n(\r)\, \cos\left[\omega t + \phi_{E_n}(\r)\right] \\
  &= \sum\limits_{n=1}^3 \hat{x}_n^{\prime\prime} \, E_n(\r)\, \cos(\omega t)\, \cos\left[ \phi_{E_n}(\r)\right] - \sin(\omega t)\, \sin\left[ \phi_{E_n}(\r)\right]\\
  &=\cos(\omega t) \, \sum\limits_{n=1}^3 \hat{x}_n^{\prime\prime} \, E_n(\r)\, \cos\left[ \phi_{E_n}(\r) \right] \\
  &+\sin(\omega t) \, \sum\limits_{n=1}^3 \hat{x}_n^{\prime\prime} \, E_n(\r)\, \sin \left[ \phi_{E_n}(\r) \right] \\
=======
	\ert = & \sum\limits_{n=1}^3 \hat{x}_n^{\prime\prime} \cdot \E_n(\r)\cdot \cos\left[\omega t + \phi_{E_n}(\r)\right] \\
	= & \sum\limits_{n=1}^3 \hat{x}_n^{\prime\prime} \cdot \E_n(\r)\cdot \left\lbrace\cos(\omega t)\cdot \cos\left[ \phi_{E_n}(\r)\right] - sin(\omega t)\cdot sin\left[ \phi_{E_n}(\r)\right]\right\rbrace\\
...
\begin{esp}
  \E^R &= E^R_{x^{\prime}} \, \hat{x}^{\prime}+E^R_{y^{\prime}} \, \hat{y}\prime \\
  \E^I &= E^I_{x^{\prime}} \, \hat{x}^{\prime}+E^I_{y^{\prime}} \, \hat{y}\prime \\
  \e &= (E^R_{x^{\prime}}\, \hat{x}^{\prime}+ E^R_{y^{\prime}})\, \cos(\omega t) - (E^I_{x^{\prime}}\, \hat{x}^{\prime}+ E^I_{y^{\prime}})\, \sin(\omega t)\\
  &= \left[E^R_{x^{\prime}} \, \cos(\omega t)-E^I_{x^{\prime}}\, \sin(\omega t)\right]\, \hat{x}^{\prime} + \left[E^R_{y^{\prime}} \, \cos(\omega t) -E^I_{y^{\prime}}\, \sin(\omega t)\right]\, \hat{y}\prime \\
\end{esp}
...
\begin{esp}
  \e(t) &= \Re[\E\, e^{\jmath \omega t}] \quad \E \in \C^3 \\
  &=\Re\left[\left(\E^R + \jmath \E^I\right)\,\left(\cos(\omega t) + \jmath \sin(\omega t)\right)\right] \\
	&= \E^R \, \cos(\omega t) - \E^I\, \sin(\omega t) \\
  &= a \, \cos(\omega t + \phi)\, \hat{x} \pm b \, \sin(\omega t + \phi)\, \hat{y}
\end{esp}
...
\begin{esp*}
	\Re[p^\prime]
	&= \left \| \frac{E_{y^{\prime}}}{E_{x^{\prime}}} \right \| \, \underbrace{\cos\left( \frac{\pi}{2} +\phi_{y^{\prime}}-\phi_{x^{\prime}} \right)}_{\text{verso di polarizzazione}}
\end{esp*}
