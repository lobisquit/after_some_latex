...
\section{Potenza dell'onda elettromagnetica}
	...
	\begin{esp}
		& \rot \h \cdot \e - \h \cdot \rot \e
			= \e \jt + \sigma |\e|^2 + \epsilon \e \deriv{\e}{t} - \h \mu \deriv{\h}{t} \\
		& -\diverg(\e \times \h) - \e \jmath = \sigma |\e|^2 + \epsilon \deriv{|\e|^2}{t} + \mu \deriv{|\h|^2}{t}
	\end{esp}

	\subsection{Potenza con i vettori di Steinmetz}
