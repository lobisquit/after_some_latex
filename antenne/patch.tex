...
\begin{esp}\label{eq:paramPatch}
  \epsilon_{re} = \frac{\epsilon_r+1}{2} +\frac{\epsilon_r-1}{2}\sqrt{1+\frac{10 h}{W}} \text{ \parbox{3cm}{ costante dielettrica efficace dell'isolante}}
  ...
  B_\%&= 3.77 \cdot \frac{\epsilon_r-1}{\epsilon_r^2} \cdot \frac{W}{L}\cdot \frac{h}{\lambda} \text{\parbox{4cm}{ percentuale di banda sfruttata dalla patch}}
\end{esp}
